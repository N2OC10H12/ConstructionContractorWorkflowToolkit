...
import com.company.ConstructionContractorWorkflowToolkit.estimate.dto.pdf.EstimatePdfDesignerBlockResponse;
import com.company.ConstructionContractorWorkflowToolkit.estimate.dto.pdf.EstimatePdfDesignerRegistryResponse;
import com.company.ConstructionContractorWorkflowToolkit.estimate.dto.pdf.EstimatePdfDesignerVariableResponse;
...
public class EstimatePdfTemplateDesignerRegistryService {
        ...
        private List<EstimatePdfDesignerVariableResponse> variables() {
                return List.of(
                                ...
                                variable("COMPANY_INTRODUCTION",
                                                "Company Introduction",
                                                "Company",
                                                "Company introduction displayed on the estimate title page",
                                ...
                                variable("BID_SCOPE",
                                                "Bid Scope",
                                                "Estimate",
                                                "Bid-specific estimate scope displayed on the title page",
                                                "{{model.estimateScope}}",
                                                "Provide and install the materials described in this estimate."),
        ...
        private List<EstimatePdfDesignerBlockResponse> blocks() {
                return List.of(
                                ...
                                block("JOB_INFO", "Job Info", "Estimate", "Job information section", false, false,
                                                ...
                                                List.of("font-family", "font-size", "color", "background-color",
                                                                "padding", "margin", "border")),
                                block("COMPANY_INTRODUCTION",
                                                "Company Introduction",
                                                "Estimate",
                                                "Protected dynamic company introduction block",
                                                true,
                                                true,
                                                true,
                                                List.of(
                                ...
                                block("BID_SCOPE",
                                                "Bid Scope",
                                                "Estimate",
                                                "Protected dynamic bid scope block",
                                                true,
                                                true,
                                                true,
                                                List.of(
